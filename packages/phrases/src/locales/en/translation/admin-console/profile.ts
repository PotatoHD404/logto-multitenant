const profile = {
  ...
  account_activity: {
    ...
    profile_updated_during_signin: 'Profile updated during sign in',
    profile_updated_during_registration: 'Profile updated during registration',
    profile_updated_during_password_reset: 'Profile updated during password reset',
    password_sign_in: 'Password sign in',
    verification_code_sign_in: 'Verification code sign in',
    social_sign_in: 'Social sign in',
    sso_sign_in: 'SSO sign in',
    verification_code_registration: 'Verification code registration',
